...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
        ...
        NSLog(@"MobileWebApplicationTemplate launchOptions = %@", url);
    }
...
// only valid if MobileWebApplicationTemplate-Info.plist specifies a protocol to handle
